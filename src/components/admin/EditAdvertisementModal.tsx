...
export default function EditAdvertisementModal({ isOpen, onClose, onSuccess, ad }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Advertisement updated", { id: toastId });
      onSuccess();
      onClose();
    } catch (error) {
      toast.error("Failed to update advertisement", { id: toastId });
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      ...
      >
        <h2 className="text-2xl font-bold mb-6 text-gray-800">Edit Advertisement</h2>
